...
#define TIME_DEBUG_OUT debug_out << "TIME " <<"not implemented yet" << "s ~~~~~: "
...
void waitForAttach(int rankNo){
    int i = 0;
    char hostname[256];
    gethostname(hostname, sizeof(hostname));
    printf("PID %d on %s ready for attach\n Rank No %d\n", getpid(), hostname,rankNo);
    fflush(stdout);
    while (0 == i)
        sleep(5);
}
...
//    else if (rank_run(m3_my_rank)){
//        // do something to handle this error
//        cout<< "Neither master nor slave:  rank No. "<<m3_my_rank<<endl;
//        //if(m3_my_rank==1) waitForAttach(m3_my_rank);
//    }
//
//    // debug
//    // running flag
...
//        if (subset_info.save_index>=0){
//            // Save subset_config
//            // Format: filenapme_index label_1 label_2 subset_num_1 subset_num_2 memory(Byte)
//            // Format: (last line) process_1 process_2 start_1 start_2 end_1 end_2
//            subset_config << subset_info.save_index
//                << " "
//                << subset_info.label_1
